...
KONIG_SERVER_CLIENT_IGNORE(MessageType::requestConcessionChoice)
KONIG_SERVER_CLIENT_IGNORE(MessageType::notifyConcession)
...
KONIG_SERVER_CLIENT_IGNORE(MessageType::notifyOuvert)
...
KONIG_SERVER_CLIENT_REMOTE_RETURN(concessionChoice, choice)
